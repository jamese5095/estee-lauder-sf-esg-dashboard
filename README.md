...
- `assets/optimization.js` — targeted road-to-rail activity and interactive carbon-impact calculation.
...
- Optimization changes only selected `Fuel vehicle` transport activity; existing 30T, other road, rail, pick-up and delivery emissions remain in the baseline. The observed rail-chain intensity is contextual, not the model's rail transport factor.
